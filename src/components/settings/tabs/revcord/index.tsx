        ...
        <SettingsTab>
            {isDonor(user?.id)
                ...
                : (
                    <SpecialCard
                        ...
                        description="Please consider supporting the development of Revcord by donating!"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Revcord you now have a cool new badge!"
                    ...
                    {!IS_WEB && (
                        <>
                            ...
                            <QuickAction
                                ...
                                action={() => RevcordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => RevcordNative.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </section>
...
export default wrapTab(RevcordSettings, "Revcord Settings");
