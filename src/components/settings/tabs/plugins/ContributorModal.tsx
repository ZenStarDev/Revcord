...
function ContributorModal({ user, modalProps }: { user: User; modalProps: RenderModalProps; }) {
    ...
    const ContributedHyperLink = <Link href="https://revcord.dev/source">contributed</Link>;
        ...
        <Modal
            ...
            subtitle={
                plugins.length
                    ...
                    : (
                        <Forms.FormText>
                            This person has not made any plugins. They likely {ContributedHyperLink} to Revcord in other ways!
                        </Forms.FormText>
                    )
            }
        >
