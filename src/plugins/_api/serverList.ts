    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(Revcord.Api.ServerList.renderAll(Revcord.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "Revcord.Api.ServerList.renderAll(Revcord.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});
