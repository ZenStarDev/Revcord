...
console.log("[Revcord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Revcord");
    ...
    console.log("[Revcord] Running in vanilla mode. Not loading Revcord");
}

console.log("[Revcord] Loading original Discord app.asar");
