...
const RENDERER_CSS_PATH = join(__dirname, IS_VESKTOP ? "revcordDesktopRenderer.css" : "renderer.css");
...
ipcMain.handle(IpcEvents.OPEN_MONACO_EDITOR, async () => {
    const title = "Revcord QuickCSS Editor";
    ...
    const win = new BrowserWindow({
        ...
        webPreferences: {
            preload: join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "revcordDesktopPreload.js"),
