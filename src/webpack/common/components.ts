...
import * as t from "@revcord/discord-types";
...
export const Forms = {
    ...
    /** @deprecated use Heading from Revcord */
    FormTitle: Heading,
    /** @deprecated use Paragraph from Revcord */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from Revcord */
export const Text = TextCompat;
/** @deprecated use Button from Revcord */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from Revcord */
...
/** @deprecated import from @revcord/components */
