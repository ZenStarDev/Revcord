...
const sourceMapFooter = s => watch ? "" : `//# sourceMappingURL=revcord://${s}.js.map`;
...
const buildConfigs = ([
    // Discord Desktop main & renderer & preload
    {
        ...
        footer: { js: "//# sourceURL=file:///RevcordPatcher\n" + sourceMapFooter("patcher") },
        sourcemap,
        plugins: [
    ...
    {
        ...commonOpts,
        entryPoints: ["src/Revcord.ts"],
        outfile: "dist/renderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///RevcordRenderer\n" + sourceMapFooter("renderer") },
        globalName: "Revcord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=file:///RevcordPreload\n" + sourceMapFooter("preload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "true",
    ...
    // Revcord Desktop main & renderer & preload
    {
        ...nodeCommonOpts,
        entryPoints: ["src/main/index.ts"],
        outfile: "dist/revcordDesktopMain.js",
        footer: { js: "//# sourceURL=file:///RevcordDesktopMain\n" + sourceMapFooter("revcordDesktopMain") },
        sourcemap,
        plugins: [
            ...nodeCommonOpts.plugins,
            globNativesPlugin
    ...
    },
    {
        ...commonOpts,
        entryPoints: ["src/Revcord.ts"],
        outfile: "dist/revcordDesktopRenderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///RevcordDesktopRenderer\n" + sourceMapFooter("revcordDesktopRenderer") },
        globalName: "Revcord",
        sourcemap,
        plugins: [
            globPlugins("vesktop"),
    ...
    },
    {
        ...nodeCommonOpts,
        entryPoints: ["src/preload.ts"],
        outfile: "dist/revcordDesktopPreload.js",
        footer: { js: "//# sourceURL=file:///RevcordPreload\n" + sourceMapFooter("revcordDesktopPreload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "false",
